// app/admin/settings/export_data/device-history/page.tsx
"use client";

import Link from "next/link";

export default function DeviceHistoryExportPage() {
    return (
        <div>
