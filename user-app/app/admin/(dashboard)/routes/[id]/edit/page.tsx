// app/admin/routes/[id]/edit/page.tsx
"use client";
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-3 mb-8">
        <Link href={`/admin/routes/${routeId}`} className="text-white hover:text-[#96DDFF] transition">
          <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 19l-7-7 7-7" />
          </svg>
        </Link>
        <h1 className="text-2xl font-bold text-white font-['Bai_Jamjuree']">
          Route Details – R{String(routeId).padStart(3, "0")} ({formData.routeName || "N/A"})
        </h1>
      </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="flex justify-between items-center py-2 border-b border-[#2C2D33]">
                ...
                <span className="text-white font-['Inter'] text-sm">R{String(routeId).padStart(3, "0")}</span>
              </div>
              ...
              <div className="mt-4">
                ...
                <input
                  ...
                  className="w-full px-4 py-3 bg-[#171821] text-white rounded-lg border border-[#2C2D33] focus:outline-none focus:border-[#96DDFF] font-['Inter'] text-sm placeholder:text-[#D2D2D2]"
                  required
                />
              </div>
              ...
              <div className="mt-4">
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full px-4 py-3 bg-[#171821] text-white rounded-lg border border-[#2C2D33] focus:outline-none focus:border-[#96DDFF] font-['Inter'] text-sm placeholder:text-[#D2D2D2] resize-none"
                />
              </div>
