...
export default function CustomDropdown({
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      {/* Trigger - YOUR ORIGINAL FLOATING DROPDOWN (unchanged) */}
      <div
      ...
      >
        <span className={`font-['Inter'] text-sm ${selectedOption ? 'text-gray-800' : 'text-gray-400'}`}>
          {loading ? "Loading routes..." : (selectedOption?.routeName || placeholder)}
        </span>
      ...
      {/* Popup Options Container - MATCHES YOUR FIGMA CSS */}
      {isOpen && !loading && (
